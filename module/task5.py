...
FILE_NAME = "users.json" if __name__ == "__main__" else "module/users.json"
...
class User:
    def __init__(self, name: str, id_: str, level: str | int):
        self.name = name
        self.id = int(id_)
